                                        ...
                                        'items': {
                                            ...
                                            'properties': {
                                                'attrs': {
                                                    ...
                                                    'properties': {
                                                        '.element-shape': {
                                                            'description': 'The component shape attributes',
                                                            'type': 'object',
                                                            'properties': {
                                                                'class': {
                                                                    'description': 'The component shape display attributes',
                                                                    'type': 'string'
                                                                }
                                                            }
                                                        },
                                                        'text': {
                                                            ...
                                                            'properties': {
                                                                'text': {
                                                                    'description': 'The component text contents',
                                                                    'type': 'string'
                                                                }
                                                            },
                                                            'required': [ 'text' ]
                                                        ...
                                                        '.element-text': {
                                                            ...
                                                            'properties': {
                                                                'class': {
                                                                    'description': 'The component text display attributes',
                                                                    'type': 'string'
                                                                }
                                                            }
                                                        }
                                                ...
                                                'isEncrypted': {
                                                    'description': 'The component flag set if the data flow or store is encrypted',
                                                    'type': 'boolean'
                                                },
                                                'isSigned': {
                                                ...
                                                'labels': {
                                                    'description': 'The floating labels used for boundary or data-flow',
                                                    'type': 'array',
                                                    'items': {
                                                        'type': 'object',
                                                        'properties': {
                                                            ...
                                                            'attrs': {
                                                                'description': 'The label text attributes',
                                                                'type': 'object',
                                                                'properties': {
                                                                    'text': {
                                                                        'description': 'The text attributes',
                                                                        'type': 'object',
                                                                        'properties': {
                                                                            'font-size': {
                                                                        ...
                                                                        'required': ['font-size', 'font-weight', 'text']
                                                                    }
                                                                },
                                                                'required': ['text']
                                                            }
                                                ...
                                                'source': {
                                                    ...
                                                    'properties': {
                                                        'id': {
                                                            'description': 'The data-flow source component',
                                                            'type': 'string'
                                                        },
                                                        'x': {
                                                ...
                                                'target': {
                                                    ...
                                                    'properties': {
                                                        'id': {
                                                            'description': 'The data-flow target component',
                                                            'type': 'string'
                                                        },
                                                        'x': {
